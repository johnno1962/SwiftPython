...
public func mandelbrot(h: Any? = nil, w: Any? = nil, maxit: Any? = 20, _ _kw: [String: Any]? = nil) -> PythonObject {
    return mandelbrotFunction.call(args: [h, w, maxit], kw: _kw)
}

public func mandelbrot(_ _h: Any? = nil, _ _w: Any? = nil, _ _maxit: Any? = 20) -> PythonObject {
    return mandelbrot(h: _h, w: _w, maxit: _maxit)
}

private let newComplexFunction = complexModule.function(named: "newComplex")

public func newComplex(real: Any? = nil, imag: Any? = nil, _ _kw: [String: Any]? = nil) -> Complex {
    return newComplexFunction.call(args: [real, imag], kw: _kw).asPythonObject(of: Complex.self)
}

public func newComplex(_ _real: Any? = nil, _ _imag: Any? = nil) -> Complex {
